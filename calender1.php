...
$your_row=mysqli_fetch_array($quercall);

$event_from_database=json_encode($your_row['json']);
...
<main class="d-flex flex-nowrap">
  ...
  <div class="d-flex flex-column flex-shrink-0 bg-body-tertiary" style="width: 4.5rem;">
    ...
    <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
      <li class="nav-item">
        <a href="http://localhost/phpprograms/calender/dashboard1.php" class="nav-link active py-3 border-bottom rounded-0" aria-current="page" title="Home" data-bs-toggle="tooltip" data-bs-placement="right">
...
$(document).ready(function(){
    ...
    function renderEventCal(){
                ...
                var json_to_display=<?php echo $event_from_database; ?>;
                var parsed_json=JSON.parse(json_to_display);
                // console.log(parsed_json);               
                for(let i=0;i<parsed_json.length;i++){

                    $('#calendar').fullCalendar('renderEvent',parsed_json[i])
                    console.log(parsed_json[i])
